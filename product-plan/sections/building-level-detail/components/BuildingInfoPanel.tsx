...
export function BuildingInfoPanel({ building, parentZone, onBackToZone }: BuildingInfoPanelProps) {
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center gap-2">
          <div
            ...
            style={{ backgroundColor: parentZone.color, color: parentZone.holcGrade === 'C' ? '#0f172a' : '#fff' }}
          >
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          <div className="w-9 h-9 rounded-lg bg-slate-800/60 flex items-center justify-center mb-3">
            <svg className="w-4.5 h-4.5 text-slate-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
  ...
  return (
    <div className="p-4 space-y-4" style={{ fontFamily: '"Inter", system-ui, sans-serif' }}>
      ...
      <nav className="flex items-center gap-1.5 text-[11px]">
        ...
        <span className="text-slate-300 font-medium truncate">{building.address}</span>
      </nav>
      ...
      <div>
        ...
        <div className="flex items-center gap-2 mt-1.5">
          <span
            ...
            style={{ backgroundColor: `${era.color}15`, color: era.color, border: `1px solid ${era.color}30` }}
          >
            <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: era.color }} />
            {era.label}
          </span>
          <span
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2.5">
          ...
          <div className="bg-slate-800/40 rounded-lg px-3 py-2.5 border border-slate-700/20">
            ...
            <div className="text-lg font-bold text-slate-200 leading-none" style={{ fontFamily: '"Space Grotesk", system-ui, sans-serif' }}>
              {building.stories}
            </div>
          </div>
          ...
          <div className="bg-slate-800/40 rounded-lg px-3 py-2.5 border border-slate-700/20">
            ...
            <div className="flex items-center gap-1.5">
              <div className={`w-2 h-2 rounded-full ${building.ownerOccupied ? 'bg-green-500' : 'bg-red-500/60'}`} />
      ...
      <div className="flex items-center gap-2">
        <div className={`px-2 py-1 rounded ${grade.bg} border ${grade.border}`}>
          <span className={`text-[10px] font-bold ${grade.text}`}>{parentZone.holcGrade}</span>
        </div>
        <div>
