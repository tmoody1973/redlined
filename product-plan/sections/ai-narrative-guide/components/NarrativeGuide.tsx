      ...
      <div className="shrink-0 px-4 py-2.5 border-b border-slate-800/80">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            title={conversation.narrationMuted ? 'Unmute narration' : 'Mute narration'}
          >
            {conversation.narrationMuted ? (
          ...
          <div className="flex items-center gap-1.5 mt-1.5">
            ...
            <span
              ...
              style={{
                ...
                color: zoneContext.holcGrade === 'D' ? '#F44336'
                  : zoneContext.holcGrade === 'C' ? '#FFEB3B'
                  : zoneContext.holcGrade === 'B' ? '#2196F3'
                  : '#4CAF50',
              }}
            >
              {zoneContext.holcId}
